...
async def create_final_package(
    ...
    try:
        ...
        from app.workflows.phase4_nodes import _calculate_detailed_esg_metrics, _extract_detailed_tools, _add_icon_names
        ...
        tools_with_icons = _add_icon_names(detailed_tools)
        ...
        package = {
            ...
            # NEW: Detailed ESG metrics generated by AI
        ...
        logger.info("[Phase 4] ✓ Full package created with detailed ESG metrics")
        return package
