      ...
      <div className="container mx-auto px-4 py-8">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 sticky top-8">
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Tell us what recyclable items you have (e.g., bottles, cans, cardboard)
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                ...
                {selectedIdea && (
                  <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <h3 className="font-semibold text-green-900 mb-2">Selected Idea</h3>
                    <p className="text-sm text-green-800 font-medium">{selectedIdea.title}</p>
                    <p className="text-xs text-green-700 mt-1">{selectedIdea.one_liner}</p>
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-gray-50 rounded-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Example Inputs</h2>
